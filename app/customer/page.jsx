  ...
  return (
    <section className='h-screen customersection'>
      <div className=' flex azile '>
        ...
        <Image className='img3 relative grayscale' src={img3} alt='Man on a phone call' width={494} height={506}/>
        <Image className='img5 absolute z-10 rounded-lg ' src={img5} alt='infographic image' width={251} height={388}/>
        </div>
        <div className='flex flex-col thirddiv items-center'>
